...
class template_created extends base {
     ...
     * @return base
     */
    public static function create_strict(template $template, quiz_settings $quizsettings, string $courseid,
                                         context_module $context, string $url) : base {
        global $USER;
    ...
    public function get_description() {
        return "The user with id '$this->userid' has created a template with id '$this->objectid' in the "
                . "Quiz id '{$this->other['quizid']}'.";
    }
